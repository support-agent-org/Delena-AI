          ...
          repl: z
            .object({
              ws_url: z
                .string()
                .optional()
                .describe("WebSocket URL for open-codemode server. Default: ws://localhost:9733"),
              exclude_tools: z
                .array(z.string())
                .optional()
                .describe("Tool ID patterns to exclude from the REPL sandbox. Supports trailing * wildcards."),
              timeout: z
                .number()
                .int()
                .positive()
            ...
            .optional()
            .describe("Configuration for the REPL tool (sandboxed code execution via open-codemode)"),
        })
        .optional(),
    })
    .strict()
