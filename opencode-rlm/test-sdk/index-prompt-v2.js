      ...
      body: {
        config: {
          agent: {
            ...
            plan: { disable: true },
            testAgent: {
              prompt: "You are a test agent. Use  to read files and process data and tell me the full path of the directory you are in. ",
              description: "Test agent for functionality",
              mode: "primary",
              tools: {
